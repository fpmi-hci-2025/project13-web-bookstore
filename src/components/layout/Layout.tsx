      ...
      <footer className="bg-on-primary text-secondary-300 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-white font-display font-semibold text-lg mb-4">BookStore</h3>
              <p className="text-sm">
                Your destination for the best books. Discover, read, and share your favorite stories.
              </p>
            </div>
            <div>
